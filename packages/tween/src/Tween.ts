...
import { Component, PropertyExtension, UpdateContext } from '@e2d/engine';
...
export class TweenExtension implements PropertyExtension {
	update(entity: Component, context: UpdateContext) {
